...
namespace ElephantSDK
{
    ...
    public class ElephantCore : MonoBehaviour
    {
        ...
        private IEnumerator InitSDK(bool isOldUser)
        {
            ...
            Elephant.Core.Elephant.Event("open_request", -1, parameters);
            ...
            if (IsForceUpdateNeeded())
            {
                ...
                Elephant.Core.Elephant.Event("force_update_seen", -1, forceUpdateEventParams);
        ...
        private void SendVersionsEvent()
        {
            ...
            Elephant.Core.Elephant.Event("elephant_sdk_versions_info", -1, parameters);
        }
            ...
            else
            {
                try
                {
                    ...
                    else if (request.responseCode == 204)
                    {
                        ...
                        if (a != null)
                        {
                            Elephant.Core.Elephant.Event("hashed_open_response", -1);
                            openRequestSucceded = true;
                            openResponse = a;
                        }
                    }
        ...
        private IEnumerator IsIapBannedRequest(Action<bool, string> callback)
        {
            ...
            if (request.isNetworkError)
            {
                ...
                Elephant.Core.Elephant.ShowAlertDialog("Error", "Something went wrong. Please try again.");
            }
            else
            {
                try
                {
                    ...
                    if (iapStatusResponse != null)
                    {
                        ...
                        if (iapStatusResponse.is_banned)
                        {
                            ...
                            Elephant.Core.Elephant.ShowAlertDialog(iapStatusResponse.link, iapStatusResponse.message);
                        }
...
//                Log("Request Failed Parsed -> " + req.tryCount + " => " + req.url + " - " + req.data);
        ...
        private void ReportLatestCrashLog()
        {
            ...
            Elephant.Core.Elephant.Event("Application_last_crash_log", MonitoringUtils.GetInstance().GetCurrentLevel(), parameters);
        }
        ...
        private void OnLowMemory()
        {
            ...
            Elephant.Core.Elephant.Event("Application_low_memory", MonitoringUtils.GetInstance().GetCurrentLevel());
        }
        ...
        void setConsentStatus(string message)
        {
            ...
            Elephant.Core.Elephant.Event("idfa_consent_change", -1, parameters);
        ...
        void sendUiConsentStatus(string message)
        {
            ...
            var parameters = Params.New();
            parameters.Set("status", message);
            Elephant.Core.Elephant.Event("idfa_ui_consent_change", -1, parameters);
            consentStatus = message;
        }
        ...
        void triggerConsentResult(string message)
        {
            var parameters = Params.New();
            parameters.Set("status", message);
            Elephant.Core.Elephant.Event("set_idfa_consent_result", -1, parameters);
